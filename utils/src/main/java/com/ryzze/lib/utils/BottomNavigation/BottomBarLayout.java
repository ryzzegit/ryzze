...
public class BottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public BottomBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.BottomItemInputLayout);
        mSmoothScroll = ta.getBoolean(R.styleable.BottomItemInputLayout_rzz_smoothScroll, false);
        ta.recycle();
    }
